    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 1 can't access LOG_GROUP_ID"
                )
        ...
        if config.STRING2:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 2 can't access LOG_GROUP_ID"
                )
        ...
        if config.STRING3:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 3 can't access LOG_GROUP_ID"
                )
        ...
        if config.STRING4:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 4 can't access LOG_GROUP_ID"
                )
        ...
        if config.STRING5:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 5 can't access LOG_GROUP_ID"
                )
